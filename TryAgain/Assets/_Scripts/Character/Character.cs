...
public class Character : MonoBehaviour
{
	...
	[SerializeField] protected Detector attackDetector;
	...
	protected CharacterInput CurrentInput;
	private Controller2D _controller;
	private Vector3 _velocity;
	
	public bool Dead { get; protected set; }

	protected void Init(float gravity, float maxJumpVelocity, float minJumpVelocity)
	{
	...
	private void UpdateCharacter(CharacterInput input)
	{
